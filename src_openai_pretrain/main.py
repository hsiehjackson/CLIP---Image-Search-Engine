...
import clip
from clip_config import vitb32_config, rn50_config, rn101_config
from utils import convert_32to16
...
def main(args):
    ...
    convert_32to16(model)
    print(f'Use {args.pretrain_clip}')   

        
    # Setting
    transform_sample = transforms.Compose([
            transforms.Resize(args.image_resolution, interpolation=Image.BICUBIC),
